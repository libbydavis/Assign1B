...
function SubmitArticle() {
    ...
    return (
        <div className="submitDiv">
            ...
            <input placeholder="authors" id="authors" value={article.authors} onChange={handleChange}></input>
            ...
            <input placeholder="journal name" id="journalName" value={article.journalName} onChange={handleChange}></input>
            <input placeholder="volume" id="volume" value={article.volume} onChange={handleChange}></input>
            <input placeholder="doi" id="doi" value={article.doi} onChange={handleChange}></input>
